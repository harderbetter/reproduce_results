...
def twp_run(arg_parser):
    print("%%%%ryb twp")
    # print("%%%%ryb twp",arg_parser.summary())
    ...
    eta_1 = arg_parser.eta_1  # step size of primal update
    eps = arg_parser.eps
...
if __name__ == "__main__":
    ...
    eta_1 = 0.2  # step size of primal update
    eps = 0.5
    num_neighbors = 3
    ...
    print(lamb)
    start = time.time()
    twp(d_feature, lamb, tasks, data_path, dataset, save,
